...
# Find employees with 2 or more jobs
multi_job_employees = job_df.groupby("EMPLOYEE_ID").size()
multi_job_ids = multi_job_employees[multi_job_employees >= 2].index

print("Employees with 2 or more jobs:", list(multi_job_ids))
